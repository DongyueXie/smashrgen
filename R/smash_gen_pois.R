...
#'@param method: smoothing method, smash or ti.thresh. When n is large, ti.thresh is much faster.
...
smash.gen.pois = function(x,sigma=NULL,s=1,method='ti.thresh',
                          ash.pm=FALSE,eps=0.01, filter.number = 1,family = "DaubExPhase"){
